...
# ==========================================
st.set_page_config(
    page_title="SILC Consultas Profesionales - Rubio Intelligence Systems", 
    page_icon="⚖️", 
    layout="centered"
)

# Estilos CSS personalizados para identidad visual y muro de pago (Plan Profesional)
st.markdown("""
<style> 
...
# LÍMITE EXCLUSIVO PLAN PROFESIONAL: 30 Consultas Diarias
LIMIT_PREGUNTAS = 30
...
if st.session_state.conteo_preguntas >= LIMIT_PREGUNTAS:
    st.markdown("""
        <div class="bloqueo-container">
            <h3 style="color: #002D52;">⚠️ Has alcanzado tu límite de 30 consultas diarias</h3>
            <p>Tu acceso se restablecerá automáticamente a la medianoche (Hora CDMX). Si tu firma legal requiere un flujo operativo mucho más robusto, actualiza al <b>Plan Premium / Corporativo</b>:</p>
            <div class="beneficio-item">🚀 Hasta 100 consultas diarias en el motor SILC de Inteligencia Legal.</div>
            <div class="beneficio-item">📄 30 descargas diarias de escritos complejos en Word (Demandas, Amparos, Contratos).</div>
            <div class="beneficio-item">🏢 Soporte multi-licencia para integrar a todo tu equipo de abogados litigantes.</div>
            <div class="beneficio-item">⚡ Acceso prioritario en servidores de ultra-alta velocidad para litigar sin pausas.</div>
        </div>
        """, unsafe_allow_html=True)
    
    st.link_button(
        "💎 MEJORAR AL PLAN PREMIUM / CORPORATIVO", 
        url="https://silcmexico.com/sc-bridge/plans/premium-upgrade",
        use_container_width=True,
        type="primary"
    )
else:
    if prompt := st.chat_input("Plantea tu interrogante o caso jurídico de alta complejidad..."):
